...
import { loginController, registerController, validateTokenController, logoutController, verifyCodeController, resetPasswordController, requestCodeController  } from "../controllers/authController.js";
...
router.post("/auth/verify-code", passwordResetLimiter, verifyCodeValidations, errorsIsEmpty, verifyCodeController);
router.post("/auth/reset-password", passwordResetLimiter, resetPasswordValidations, errorsIsEmpty, resetPasswordController);
