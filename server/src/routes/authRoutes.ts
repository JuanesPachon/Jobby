...
import { loginController, registerController, validateTokenController, logoutController, verifyCodeController, userController, resetPasswordRequestController  } from "../controllers/authController.js";
...
router.post("/auth/reset-password", resetPasswordValidations, errorsIsEmpty, userController);
