...
export class TaskCard implements OnInit {
    ...
    get applyButtonClass(): string {
        const baseClass =
            'cursor-pointer px-6 xl:px-8 h-[35px] xl:h-[40px] rounded-full text-sm border border-black whitespace-nowrap font-medium transition-colors';
    ...
    get mobileApplyButtonClass(): string {
        const baseClass =
            'flex-1 h-9 sm:h-10 md:h-9 rounded-lg text-xs sm:text-sm font-medium border border-black transition-colors';
