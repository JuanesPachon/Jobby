        ...
        switch (status) {
            case 'applied':
                return {
                    ...
                    description:
                        'Las tareas donde te postulaste pero aún no has sido seleccionado aparecerán aquí.',
                };
            case 'selected':
                return {
                    title: 'No has sido seleccionado en ninguna tarea',
                    description:
                        'Las tareas donde fuiste elegido pero aún no han comenzado aparecerán aquí.',
                };
            case 'in_progress':
                return {
                    title: 'No tienes tareas en progreso',
                    description:
                        'Las tareas donde fuiste seleccionado y ya están en ejecución aparecerán aquí.',
                };
            case 'completed':
                return {
            ...
            case 'cancelled':
                return {
                    ...
                    description:
                        'Las tareas donde fuiste seleccionado pero fueron canceladas en los últimos 7 días aparecerán aquí.',
                };
            default:
                return {
                    title: 'No te has postulado a ninguna tarea',
                    description:
                        'Explora oportunidades laborales y postúlate a las tareas que te interesen.',
                };
        }
    }
